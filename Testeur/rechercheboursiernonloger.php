...
<body style="background: #F2F2F2;" >
    ...
    <div class="w3-bar w3-light-grey w3-border w3-xxlarge" style="width:100%; height: 70px; margin-top:1%; background: #ccc;">
        ...
        <a href="#" class="w3-bar-item w3-button w3-green" style="height: 70px; width:20%; border: 1px solid; margin-left: 5%; box-shadow: 5px 5px 5px 5px;"><i class="fa fa-plus" style="margin-top: -12px;">    Boursier & Non Loger   </i></a>
