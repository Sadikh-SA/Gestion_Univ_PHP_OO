...
<body style="background: #F2F2F2;" >
    ...
    <div class="w3-bar w3-light-grey w3-border w3-xxlarge" style="width:100%; height: 70px; margin-top:1%; background: #ccc;">
        <a href="#" class="w3-bar-item w3-button w3-green" style=" height: 70px; width:20%; border: 1px solid; box-shadow: 5px 5px 5px 5px;"><i class="fa fa-graduation-cap" style="margin-top:10px;">Boursier</i></a>
        ...
        <table id="example" class="table table-striped table-bordered">
          ...
          <th>Supprimer</th>
            ...
            <tbody>
                ...
                $requete = "select libelle from Situation,Boursier where Situation.idtype=Boursier.idtype";
